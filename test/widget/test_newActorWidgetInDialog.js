require([
	...
	var ssoToken = 'AQIC5wM2LY4SfcxM8ViPzQUGIQopXafK_6dEDBRI38tDXrg.*AAJTSQACMDIAAlNLABM4MTE1MDk1OTUwMDY1Mjk4NzQ3AAJTMQACMDE.*';
	...
	var testRpActor = JSON.parse('{"adressen":[{"omschrijving_straat":"Werftsesteenweg 3 bus 10","adrestype":{"id":1},"straat":"Werftsesteenweg","huisnummer_id":2167307,"straat_id":10020,"subadres_id":413908,"huisnummer":"3","land":"BE","gemeente_id":35,"subadres":"10","id":204,"gemeente":"Heist-op-den-Berg","postcode":"2220"}],"naam":"Saelens BVBA","afkorting":"SBA","telefoons":[{"landcode":"+32","nummer":"123456789","type":{"id":1}}],"type":{"id":1},"emails":[{"type":{"id":2},"email":"bart.saelen@werk.be"}], "kbo": "0474603875", "urls":[{"type": {"id":1}, "url": "https://www.sba.be"}]}');
