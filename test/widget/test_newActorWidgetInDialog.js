require([
	...
	var ssoToken = 'AQIC5wM2LY4SfcyZca89ZsjLGArHh2q4nHhw_cQBJopsulM.*AAJTSQACMDIAAlNLABMxNDQxOTEzOTEwOTkxMDI2NjAzAAJTMQACMDE.*';
	...
	var testActor = JSON.parse('{"adres":{"omschrijving_straat":"Werftsesteenweg 3 bus 10","adrestype":{"id":1},"straat":"Werftsesteenweg","huisnummer_id":2167307,"straat_id":10020,"subadres_id":413908,"huisnummer":"3","land":"BE","gemeente_id":35,"subadres":"10","id":204,"gemeente":"Heist-op-den-Berg","postcode":"2220"},"naam":"Saelen","ids":[{"extra_id":null,"type":{"id":4}}],"voornaam":"Bart","telefoons":[{"landcode":"+32","nummer":"123456789","type":{"id":1}}],"type":{"id":1},"emails":[{"type":{"id":1},"email":"bart.saelen@geosolutions.be"}],"omschrijving":"Saelen, Bart"}');
