...
return declare("dojo.store.JsonRestCors", base, {
	// summary:
	...
	constructor: function(options){
        ...
        if(this.ssoToken!=undefined){
            this.headers = {OpenAmSSOID:this.ssoToken};
        }
	},
	...
	simplePut: function(object, options){
		// summary:
		//		Simply executes a put request with the url of the store (no identity resolution and so on)
		// object: Object
		//		The object to store.
	...
	simplePost: function(object, options){
		// summary:
		//		Simply executes a put request with the url of the store (no identity resolution and so on)
		// object: Object
		//		The object to store.
